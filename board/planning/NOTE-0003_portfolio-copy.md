...
<header>
  ...
  <p class="tagline">
    I translate complex business requirements into elegant technical solutions. Frontend development
    across AI products, web applications, and embedded systems.
  </p>
...
<section class="value-prop">
  ...
  <p class="lead">
    Most developers either understand business or write great code. I bridge both worlds.
  </p>
...
<section class="projects">
  ...
  <div class="project">
    ...
    <p class="project-summary">
      Built user-facing interface for machine learning tool. Translated complex ML outputs into
      intuitive visualizations that non-technical users could understand and act on.
    </p>
  ...
  <div class="project">
    ...
    <p class="project-summary">
      Delivered responsive component system for client with complex content requirements. Managed
      stakeholder feedback through technical constraints, keeping project on timeline.
    </p>
  ...
  <div class="project">
    ...
    <p class="project-summary">
      Created real-time dashboard connecting embedded sensors to web interface. Solved business need
      for remote monitoring with custom hardware-software integration.
    </p>
...
<section class="capabilities">
  ...
  <p class="always">
    <strong>Always:</strong> Clean, maintainable code • User-focused design • Performance-conscious
    development
  </p>
</section>
```
...
<section class="contact">
  ...
  <p class="contact-intro">Ready to bridge your business needs with technical solutions?</p>
  ...
  <p class="contact-cta">Let's discuss your next project</p>
</section>
```
