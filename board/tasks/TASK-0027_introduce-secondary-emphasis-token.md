...
During TASK-0016 migration, `emerald-300` kept showing up as a distinct role that doesn't fit cleanly into the current attention hierarchy (`foundation` = 100 / `emphasis` = 200 / `accent` = 400 / `highlight` = fuchsia-500). It sits *between* emphasis and accent — bright enough to pop past body copy but not demanding action.
